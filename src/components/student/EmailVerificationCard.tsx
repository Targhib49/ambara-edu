  ...
  return (
    <section className={`${cardCls} p-5`}>
      <div className="flex flex-wrap items-center gap-2">
        <h2 className="font-medium text-zinc-900">Email address</h2>
        <span
      ...
      <p className="mt-1 text-sm text-zinc-500">
        {verified
          ? `We know ${email} reaches you.`
          : `We sent a confirmation link to ${email}. It only tells us the address works — you can already sign in.`}
      </p>
      {!verified && (
