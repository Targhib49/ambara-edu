...
export function ResetPasswordPanel({ studentId, name }: { studentId: string; name: string }) {
    ...
    return (
      <div className="space-y-4">
        <p className="text-sm text-zinc-600">
          Done. Give {`${name} `}this password &mdash; it won&rsquo;t be shown again, and they can change it from their profile.
        </p>
        ...
        <p className="text-xs text-zinc-500">
          {name} has been signed out everywhere and will need this password to sign back in.
        </p>
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-zinc-600">
        Generates a new temporary password for {name} and shows it once, for you to pass on. It signs them out on every
        device, and their old password stops working straight away.
      </p>
